 ...
 * @author ELOISE
 */
public class IHM_test extends javax.swing.JFrame {
    
    private File fichierchat=new File("src/images/chat_bleu0.jpg");
    private BufferedImage imagechat;

    /**
     * Creates new form ihm_test
     */
    public IHM_test() {
        initComponents();
        jPaneltest.setFocusable(true);
        try{
    imagechat=ImageIO.read(fichierchat);//utilisation de plateau_de_jeu
    ...
    private void initComponents() {
        ...
        jPaneltest = new javax.swing.JPanel()
        {
            public void paintComponent(Graphics g){
                g.drawImage(imagechat,0,0, null);
            }
        }
        ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IHM_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
